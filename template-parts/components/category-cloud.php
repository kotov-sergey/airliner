...
<nav class="category-cloud" aria-label="Навигация по категориям блога">
    <ul class="category-cloud__list">
        ...
        <?php foreach ( $categories as $category ) : ?>
            ...
            <li class="category-cloud__item">
                <a href="<?php echo esc_url( $term_link ); ?>" class="pill pill--subtle category-cloud__link"><?php echo esc_html( $category->name ); ?></a>
            </li>
